...
pickers.origen.addEventListener('change', pickHandler)
pickers.destino.addEventListener('change', pickHandler)
...
function pickHandler (e) {
	...
	if(lugares.includes(origen) && lugares.includes(destino)){
...
function sendDateTime () {
	...
	var data=Date(pickers.date.value).parse('YYYY-MM-DD')
	console.log(data)
